...
export default function Index({ users, companies, filters, currentTime }: { users: User[]; companies: Company[]; filters: Filters; currentTime: string }) {
    const initialCompanyId = filters?.company_id ? String(filters.company_id) : '';
        ...
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                ...
                <form onSubmit={handleSubmit} className="mb-4 flex gap-2">
                    <Select value={data.company_id || undefined} onValueChange={(value) => setData('company_id', value === 'all' ? '' : value)}>
