...
export default function DeferredProps({ stats, users }: { stats?: { totalUsers: number; totalCompanies: number }; users?: User[] }) {
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            ...
            <div className="p-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <Deferred data="stats" fallback={<div className="rounded-lg border bg-card p-6">Loading stats...</div>}>
                    ...
                    <Deferred data="users" fallback={
                        <div className="space-y-2">
                            {[...Array(10)].map((_, i) => (
                                <div key={i} className="flex items-center justify-between rounded-lg border bg-card p-4 shadow-sm">
